...
while(getElementByXpath(`//*[@id=\"rso\"]/div/div/div[${i}]/div/h3/a`)) {
  ...
  getElementByXpath(`//*[@id=\"rso\"]/div/div/div[${i}]/div/h3/a`).setAttribute("data-index", i);;
  i++;
}


// var css = "body {width: 50%;margin: 5rem auto;}.r {z-index: 0;position: relative;}.r:before {z-index: 1;display: inline-block;position: absolute;left: -2rem;bottom: 1.2rem;margin: 0 0.5rem 0 0;width: 1.5rem;height: 1.5rem;font-size: 1.2rem;opacity: 0.5;line-height: 1.5rem;text-align: center;background-color: #ff0;border: solid 2px #000;content: attr(data-index);}",
